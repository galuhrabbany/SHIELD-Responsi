                ...
                @auth
                    ...
                    <li class="nav-item">
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button class="nav-link" type="submit"><i class="fa-solid fa-right-from-bracket"
                                    style="color: #ff0000;"></i> Logout</button>
                        </form>
                    </li>
                @endauth
                ...
                @guest
                    <li class="nav-item">
                        <a class="nav-link text-primary" href="{{ route('login') }}">
                            <i class="fa-solid fa-right-from-bracket" style="color: #002aff;"></i> Login</a>
                    </li>
                @endguest
            </ul>
        </div>
